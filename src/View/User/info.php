		...
		<div class="row"><br>
			...
			<div class="col m6 s6 offset-m2 offset-s2 middle">
				<div class="row infosUserRow">
					<h5 class="bold">Nom : </h5><p class="infoFilmP">{{$name}}</p></br>
					<h5 class="bold">Prénom : </h5><p class="infoFilmP">{{$lastName}}</p></br>
					<h5 class="bold">Email : </h5><p class="infoFilmP">{{$email}}</p></br>
