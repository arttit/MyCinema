			...
			<div class="col m8 s8 offset-m2 offset-s2 center">
				<div class="truncate bg-card-user">
					<div class="row" id="helloStr">
						<h4 id="allFIlmsTxt">Tous les films du genre {{$genreName}} :</h4>
					</div>
				</div>
			</div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="actionTable">
									<a href="<?= BASE_URI ?>\film\modify\id\{{$tab[1][$i]}}" class="btn-floating btn-edit waves-effect waves-light red"><i class="material-icons">mode_edit</i></a>
									<a href="<?= BASE_URI ?>\film\delete\id\{{$tab[1][$i]}}" class="btn-floating btn-delete btn-edit waves-effect waves-light"><i class="material-icons">delete</i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
