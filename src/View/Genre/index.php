				...
				<div class="row tableRow">
					<table class="highlight">
						...
						<tbody>
							...
							<tr>
								<td class="th">
									<a href='genre/id/<?=$tab[1][$i]?>'>{{$tab[0][$i]}}</a><br/>	
								</td>
								<td>{{$tab[2][$i]}}</td>
								<td class="actionTable">
									<a href="genre/modify/id/{{$tab[1][$i]}}" class="btn-floating btn-edit waves-effect waves-light red"><i class="material-icons">mode_edit</i></a>
									<a href="genre/delete/id/{{$tab[1][$i]}}" class="btn-floating btn-delete btn-edit waves-effect waves-light"><i class="material-icons">delete</i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
