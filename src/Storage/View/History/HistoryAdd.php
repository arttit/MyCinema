			...
			<div class="col m6 s6 offset-m2 offset-s2 middle">
				<div class="row">
					<form method="POST" action="add" id="formAddToHistory">
						...
						<?php if(isset($titleFilm)): ?>						<input value="<?= htmlspecialchars($titleFilm) ?>" type="text" name="filmName" id="autocomplete-input" class="autocomplete inputAddHistory" autocomplete="off"/><br/>
						<?php else: ?>
