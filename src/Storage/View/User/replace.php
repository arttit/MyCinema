			...
			<div class="col m6 s6 offset-m2 offset-s2 middle">
				<div class="row">	
					<form method="POST" action="modify">
						...
						<input type="text" name="nameModif" id="nameModif" value="<?= htmlspecialchars($name) ?>" />
						<label for="lastNameModif">Prénom :</label>
						<input type="text" name="lastNameModif" id="lastNameModif" value="<?= htmlspecialchars($lastName) ?>" />
						<label for="emailModif">Email :</label>
						<input type="email" name="emailModif" id="emailModif" value="<?= htmlspecialchars($email) ?>" />
