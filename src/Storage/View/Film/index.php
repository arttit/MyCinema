					...
					<table class="highlight">
						...
						<tbody>
							...
							<tr>
								...
								<td class="th"><a href='<?= BASE_URI ?>\genre\id\<?=$tab[4][$i]?>'><?= htmlspecialchars($tab[2][$i][0]['nom']) ?></a></td>
								<td><?= htmlspecialchars($tab[3][$i]) ?></td>
								<td class="actionFIlmTable">
									<a href="<?= BASE_URI ?>\film\modify\id\<?= htmlspecialchars($tab[1][$i]) ?>" class="btn-floating btn-edit btn-film waves-effect waves-light red"><i class="material-icons">mode_edit</i></a>
									<a href="<?= BASE_URI ?>\film\delete\id\<?= htmlspecialchars($tab[1][$i]) ?>" class="btn-floating btn-delete btn-film btn-edit waves-effect waves-light"><i class="material-icons">delete</i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
